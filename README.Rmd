...
Thus you can manipulate these dataframes at all steps and write midi files from R. 
However, you need to make sure yourself that the midi files you write can be understood by your softsynth; 
but [mido](https://github.com/mido/mido) (used by miditapyr) already catches some of the possible inconsistencies. 
