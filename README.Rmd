...
pyramidi is an experimental package to generate / manipulate midi data from R.
...
* played live in the R console thanks to the excellent R packages [fluidsynth](https://github.com/ropensci/fluidsynth) & [av](https://github.com/ropensci/av/) (see [here](............................................)), or
* synthesized to wav files with `fluidsynth::midi_convert()` (needs [fluidsynth](https://www.fluidsynth.org/) installed, but if I understand correctly R will do that for you),
