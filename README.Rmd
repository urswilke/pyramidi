...
The data is not yet validated, 
but [mido](https://github.com/mido/mido) (also used to write midi files) already catches some of the possible inconsistencies. 
...
*I'm not sure if that works on windows too. Perhaps there you have to configure your reticulate environment manually.*

## Usage 

### Generate a `MidiFramer` object

We can create an `MidiFramer` object by passing the file file path to the  
constructor. 
