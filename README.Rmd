...
Then, the notes' midi information (one line per `note_on`/`note_off` midi event) 
...
* See the `vignette("midi_framer")` for a brief usage introduction how to manipulate midi data.
...
* `vignette("functions_workflow")` illustrates the low-level functions of the pyramidi package
